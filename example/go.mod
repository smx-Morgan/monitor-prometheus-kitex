...
require (
	...
	github.com/cloudwego-contrib/cwgo-pkg/telemetry v0.0.0 // indirect
...
replace github.com/kitex-contrib/monitor-prometheus => D:\Projects\Go\monitor-prometheus-kitex
